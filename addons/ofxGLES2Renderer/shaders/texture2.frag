...
{	
#if TEXTURE2_ENV_MODE == GL_MODULATE
	#if TEXTURE2_FORMAT == GL_ALPHA
		...
		color.a = color.a * texture2Color.a;
	#endif
#elif TEXTURE2_ENV_MODE == GL_DECAL
	#if TEXTURE2_FORMAT == GL_ALPHA
		// undefined
	#elif TEXTURE2_FORMAT == GL_LUMINANCE
		// undefined
	...
	#endif
#elif TEXTURE2_ENV_MODE == GL_BLEND
	#if TEXTURE2_FORMAT == GL_ALPHA
		color.a = color.a * texture2Color.a;
	#elif TEXTURE2_FORMAT == GL_LUMINANCE
		...
		color.a = color.a * texture2Color.a;
	#endif
#elif TEXTURE2_ENV_MODE == GL_REPLACE
	#if TEXTURE2_FORMAT == GL_ALPHA
		...
		color = texture2Color;
	#endif
#elif TEXTURE2_ENV_MODE == GL_BLUR
...
#elif TEXTURE2_ENV_MODE == GL_COMBINE
	vec4 arg0;
	vec4 arg1;
	vec4 arg2;
	...
	#elif TEXTURE2_ENV_SRC0_RGB == GL_CONSTANT
		arg0.rgb = u_texture2EnvColor.rgb;
	#elif TEXTURE2_ENV_SRC0_RGB == GL_PRIMARY_COLOR
		arg0.rgb = v_frontColor.rgb;
	#elif TEXTURE2_ENV_SRC0_RGB == GL_PREVIOUS
		arg0.rgb = color.rgb;
	#endif

	// TODO: GL_SRC_ALPHA & GL_ONE_MINUS_SRC_ALPHA exists in SDK but no idea what they are supposed to do in this context..
	#if TEXTURE2_ENV_OPERAND0_RGB == GL_ONE_MINUS_SRC_COLOR
	...
	#elif TEXTURE2_ENV_SRC1_RGB == GL_CONSTANT
		arg1.rgb = u_texture2EnvColor.rgb;
	#elif TEXTURE2_ENV_SRC1_RGB == GL_PRIMARY_COLOR
		arg1.rgb = v_frontColor.rgb;
	#elif TEXTURE2_ENV_SRC1_RGB == GL_PREVIOUS
		arg1.rgb = color.rgb;
	#endif
	...
	#elif TEXTURE2_ENV_SRC2_RGB == GL_CONSTANT
		arg2.rgb = u_texture2EnvColor.rgb;
	#elif TEXTURE2_ENV_SRC2_RGB == GL_PRIMARY_COLOR
		arg2.rgb = v_frontColor.rgb;
	#elif TEXTURE2_ENV_SRC2_RGB == GL_PREVIOUS
		arg2.rgb = color.rgb;
	#endif
		
	#if TEXTURE2_ENV_OPERAND2_RGB == GL_ONE_MINUS_SRC_COLOR
	...
	#elif TEXTURE2_ENV_SRC0_ALPHA == GL_CONSTANT
		arg0.a = u_texture2EnvColor.a;
	#elif TEXTURE2_ENV_SRC0_ALPHA == GL_PRIMARY_COLOR
		arg0.a = v_frontColor.a;
	#elif TEXTURE2_ENV_SRC0_ALPHA == GL_PREVIOUS
		arg0.a = color.a;
	#endif
		
	#if TEXTURE2_ENV_OPERAND0_ALPHA == GL_ONE_MINUS_SRC_ALPHA
		arg0.a = 1.0 - arg0.a;
	#endif
	...
	#elif TEXTURE2_ENV_SRC1_ALPHA == GL_CONSTANT
		arg1.a = u_texture2EnvColor.a;
	#elif TEXTURE2_ENV_SRC1_ALPHA == GL_PRIMARY_COLOR
		arg1.a = v_frontColor.a;
	#elif TEXTURE2_ENV_SRC1_ALPHA == GL_PREVIOUS
		arg1.a = color.a;
	#endif
	...
	#elif TEXTURE2_ENV_SRC2_ALPHA == GL_CONSTANT
		arg2.a = u_texture2EnvColor.a;
	#elif TEXTURE2_ENV_SRC2_ALPHA == GL_PRIMARY_COLOR
		arg2.a = v_frontColor.a;
	#elif TEXTURE2_ENV_SRC2_ALPHA == GL_PREVIOUS
		arg2.a = color.a;
	#endif
		
	#if TEXTURE2_ENV_OPERAND2_ALPHA == GL_ONE_MINUS_SRC_ALPHA
		arg2.a = 1.0 - arg2.a;
	#endif
		
	// COMBINE_RGB
	#if TEXTURE2_ENV_COMBINE_RGB == GL_REPLACE
		color.rgb = arg0.rgb;
	#elif TEXTURE2_ENV_COMBINE_RGB == GL_MODULATE
		color.rgb = arg0.rgb * arg1.rgb;
	#elif TEXTURE2_ENV_COMBINE_RGB == GL_ADD
		color.rgb = arg0.rgb + arg1.rgb;
	#elif TEXTURE2_ENV_COMBINE_RGB == GL_ADD_SIGNED
		color.rgb = arg0.rgb + arg1.rgb - 0.5;
	#elif TEXTURE2_ENV_COMBINE_RGB == GL_INTERPOLATE
		color.rgb = mix(arg1.rgb, arg0.rgb, arg2.rgb);
	#elif TEXTURE2_ENV_COMBINE_RGB == GL_SUBTRACT
		color.rgb = arg0.rgb - arg1.rgb;
	#elif TEXTURE2_ENV_COMBINE_RGB == GL_DOT3_RGB
		color.r = 4.0*((arg0.r - 0.5)*(arg1.r - 0.5) + (arg0.g - 0.5)*(arg1.g - 0.5) + (arg0.b - 0.5)*(arg1.b - 0.5));
		color.g = color.r;
		color.b = color.r;
	#elif TEXTURE2_ENV_COMBINE_RGB == GL_DOT3_RGBA
		color.r = 4.0*((arg0.r - 0.5)*(arg1.r - 0.5) + (arg0.g - 0.5)*(arg1.g - 0.5) + (arg0.b - 0.5)*(arg1.b - 0.5));
		color.g = color.r;
		color.b = color.r;
		color.a = color.r;
	...
	// COMBINE_ALPHA
	#if TEXTURE2_ENV_COMBINE_ALPHA == GL_REPLACE
		color.a = arg0.a;
	#elif TEXTURE2_ENV_COMBINE_ALPHA == GL_MODULATE
		color.a = arg0.a * arg1.a;
	#elif TEXTURE2_ENV_COMBINE_ALPHA == GL_ADD
		color.a = arg0.a + arg1.a;
	#elif TEXTURE2_ENV_COMBINE_ALPHA == GL_ADD_SIGNED
		color.a = arg0.a + arg1.a - 0.5;
	#elif TEXTURE2_ENV_COMBINE_ALPHA == GL_INTERPOLATE
		color.a = mix(arg1.a, arg0.a, arg2.a);
	#elif TEXTURE2_ENV_COMBINE_ALPHA == GL_SUBTRACT
		color.a = arg0.a - arg1.a;
	#endif
#endif
